package org.liyu.live.api.error;

import org.liyu.live.web.starter.error.LiyuBaseError;
import org.liyu.live.web.starter.constants.ErrorAppIdEnum;

/**
 * @Author 傅泽杭
 * @Data 2024-04-05 14:53
 * @Description
 */
public enum ApiErrorEnum implements LiyuBaseError {
    ...
    public int getErrorCode() {
        return Integer.parseInt(ErrorAppIdEnum.LIYU_API_ERROR.getCode() + "" + errorCode);
    }
