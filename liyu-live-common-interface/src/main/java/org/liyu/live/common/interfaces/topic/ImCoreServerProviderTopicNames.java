...
public class ImCoreServerProviderTopicNames {
     ...
     * 接收im系统发送的业务消息
     */
    public static final String LIYU_LIVE_IM_BIZ_MSG_TOPIC = "liyu_live_im_biz_msg_topic";

    /**
     * 发送im的ack消息
     */
    public static final String LIYU_LIVE_IM_ACK_MSG_TOPIC = "liyu_live_im_ack_msg_topic";
