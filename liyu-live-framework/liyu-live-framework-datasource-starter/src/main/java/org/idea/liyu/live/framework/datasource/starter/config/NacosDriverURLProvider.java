package org.idea.liyu.live.framework.datasource.starter.config;
...
public class NacosDriverURLProvider implements ShardingSphereDriverURLProvider {
     ...
     * (jdbc:shardingsphere:nacos:192.168.222.1:8848:liyu-live-user-shardingjdbc.yaml?username=liyu&&password=liyu&&namespace=liyu-live-test）
     * @return
     */
    @Override
     ...
     *
     * @param url （jdbc:shardingsphere:nacos:192.168.222.1:8848:liyu-live-user-shardingjdbc.yaml?username=liyu&&password=liyu&&namespace=liyu-live-test）
     * @return
     */
    @Override
    public byte[] getContent(final String url) {
        ...
        //得到例如：192.168.222.1:8848:liyu-live-user-shardingjdbc.yaml?username=liyu&&password=liyu&&namespace=liyu-live-test 格式的url
        String nacosUrl = url.substring(url.lastIndexOf(NACOS_TYPE) + NACOS_TYPE.length());
        /**
         * 得到三个字符串，分别是：
         * 192.168.222.1
         * 8848
         * liyu-live-user-shardingjdbc.yaml
         */
         ...
         * 得到两个字符串
         * liyu-live-user-shardingjdbc.yaml
         * username=liyu&&password=liyu&&namespace=liyu-live-test
         */
