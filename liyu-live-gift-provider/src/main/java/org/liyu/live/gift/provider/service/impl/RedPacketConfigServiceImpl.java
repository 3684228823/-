...
import org.liyu.live.common.interfaces.utils.ListUtils;
import org.liyu.live.gift.constants.RedPacketStatusCodeEnum;
import org.liyu.live.gift.dto.RedPacketConfigReqDTO;
import org.liyu.live.gift.dto.RedPacketReceiveDTO;
import org.liyu.live.gift.provider.dao.mapper.RedPacketConfigMapper;
...
public class RedPacketConfigServiceImpl implements IRedPacketConfigService {
    ...
    public void receiveRedPacketHandle(RedPacketConfigReqDTO reqDTO,Integer price) {
        ...
        liyuCurrencyAccountRpc.incr(reqDTO.getUserId(), price);
    ...
    public Boolean startRedPacket(RedPacketConfigReqDTO reqDTO) {
        ...
        livingRoomReqDTO.setAppId(AppIdEnum.LIYU_LIVE_BIZ.getCode());
