package org.liyu.live.msg.provider.consumer.handler.impl;
...
import org.liyu.live.msg.provider.consumer.handler.MessageHandler;
import org.springframework.stereotype.Component;
import org.liyu.live.msg.dto.MessageDTO;
    ...
    public void onMsgReceive(ImMsgBody imMsgBody) {
        ...
        if (ImMsgBizCodeEnum.LIVING_ROOM_IM_CHAT_MSG_BIZ.getCode() == bizCode) {
            ...
            userIdList.forEach(userId -> {
                ...
                respMsg.setAppId(AppIdEnum.LIYU_LIVE_BIZ.getCode());
