...
import org.liyu.live.id.generate.enums.IdTypeEnum;
...
import org.liyu.live.user.provider.dao.mapper.IUserPhoneMapper;
import org.liyu.live.user.provider.dao.po.UserPhonePO;
...
public class UserPhoneServiceImpl implements IUserPhoneService {
    ...
    private UserLoginDTO registerAndLogin(String phone) {
        ...
        userDTO.setNickName("鲤鱼用户-" + userId);
